...
class CustomButtonWhiteSmall extends StatefulWidget {
  final Function onPressed;
  final String text;
  final bool isClickable;


  CustomButtonWhiteSmall({Key key, this.onPressed, this.text, this.isClickable = true}) : super(key: key);

  @override
  _CustomButtonWhiteSmall createState() => _CustomButtonWhiteSmall();
}

class _CustomButtonWhiteSmall extends State<CustomButtonWhiteSmall> {
